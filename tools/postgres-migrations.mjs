...
const WRITER_SOURCE_STAGE_SCRIPT = [
  ...
  "for source_path in apps/decision-server/Cargo.toml apps/decision-server/src/config.rs apps/decision-server/src/lib.rs apps/decision-server/src/main.rs apps/decision-server/src/runtime.rs apps/decision-server/src/secure_file.rs apps/decision-server/src/windows_acl.rs apps/decision-server/tests/process.rs apps/decision-server/tests/runtime_config.rs apps/decision-server/tests/runtime_integration.rs crates/event-store-contracts/src/signature.rs crates/event-store-contracts/tests/decision_event_signature.rs crates/event-store-postgres/Cargo.toml crates/event-store-postgres/src/lib.rs crates/event-store-postgres/src/reader.rs crates/event-store-postgres/tests/postgres_writer.rs crates/event-store-postgres/tests/postgres_reader.rs crates/decision-grpc/src/service.rs crates/decision-grpc/src/watch_runtime.rs crates/decision-grpc/tests/decision_service.rs crates/decision-grpc-client/Cargo.toml crates/decision-grpc-client/src/lib.rs crates/decision-grpc-client/tests/access_token.rs crates/decision-grpc-client/tests/client_config.rs crates/decision-grpc-client/tests/client_transport.rs crates/desktop-decision-grpc/Cargo.toml crates/desktop-decision-grpc/src/lib.rs crates/desktop-decision-grpc/src/tests.rs crates/decision-grpc-jwt/Cargo.toml crates/decision-grpc-jwt/src/lib.rs crates/decision-grpc-jwt/tests/jwt_authenticator.rs crates/decision-grpc-postgres/Cargo.toml crates/decision-grpc-postgres/src/pool.rs crates/decision-grpc-postgres/tests/postgres_executor.rs crates/decision-grpc-postgres/tests/reader_pool.rs crates/decision-grpc-server/Cargo.toml crates/decision-grpc-server/src/lib.rs crates/decision-grpc-server/src/config.rs crates/decision-grpc-server/src/server.rs crates/decision-grpc-server/tests/server_config.rs crates/decision-grpc-server/tests/server_startup.rs crates/decision-grpc-server/tests/server_transport.rs; do",
  '  test -f "$source_path"',
  '  test ! -L "$source_path"',
